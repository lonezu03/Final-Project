...
public enum ErrorCode {
	...
	REPORT_NOT_EXISTS(1048,"Report not exists")
	,DISLIKE_COMMENT_VALUE_NULL(1048,"Dislike comment value null")
	,LIKE_COMMENT_VALUE_NULL(1048,"Like comment value null")

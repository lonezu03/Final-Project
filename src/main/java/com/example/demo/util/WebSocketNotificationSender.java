...
/**
 * Service used to send notifications via WebSocket to a specific user or
 * broadcast to all users.
 *
 * Uses `SimpMessagingTemplate` to send messages to destinations registered
 * with STOMP.
 */
@Component
...
public class WebSocketNotificationSender {
     ...
     *
     * @param username the user's name (based on Spring Security Principal or
     *                 header)
    ...
    /**
     * Broadcasts a notification to all users listening on the `/topic/global`
     * channel.
     *
